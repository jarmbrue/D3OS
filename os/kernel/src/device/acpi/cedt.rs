...
use x86_64::{
    PhysAddr,
    structures::paging::{PhysFrame, frame::PhysFrameRange},
};
    ...
    pub fn get_structures(&self) -> Vec<&CEDTStructureHeader> {
        ...
        while remaining > 0 {
            unsafe {
                ...
                structure_ptr = (structure_ptr as *const u8).add(structure.record_length as usize)
                    as *const CEDTStructureHeader;
